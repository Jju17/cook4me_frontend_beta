...
export const ContentWithPaddingXl = tw.div`max-w-screen-xl mx-auto py-20 lg:py-16`;
...
export const ContentPaddingBottom = tw.div`max-w-screen-xl mx-auto pb-20 lg:pb-16`;
